...
#from pytorch_lightning.metrics.classification import F1, Recall, PrecisionRecall, Accuracy, Precision
...
fc_parameters = model.classifier[1].parameters()
...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("coins_squeezenet_train_loss.txt", "a")
    fv = open("coins_squeezenet_val_loss.txt", "a")
    fta = open("coins_squeezenet_train_acc.txt", "a")
    fva = open("coins_squeezenet_val_acc.txt", "a")
...
model = train(50, model, optimizer, criterion, use_cuda, 'squeezenet.pt')
test(model,criterion,use_cuda)
